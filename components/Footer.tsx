...
const FooterCol = ({ title, links }: ColumnLinks) => (
        ...
        <footer className='flexStart footer'>
            <div className='flex flex-col gap-12 w-full'>
                <div className='flex items-start flex-col'>
                    <Image src='/logo-purple.svg' width={115} height={43} alt='haxible' />
                    <p className='text-start text-sm font-normal mt-5 max-w-xs'>
                        Haxible is a worlds leading platform for creatives to grow, share, and get hired
                    </p>
                </div>
            ...
            <div className='flexBetween footer_copyright'>
                <p>
                    @ 2023 Haxible. All rights reserved.
                </p>
                <p className='text-gray'>
                    <span className='text-black font-semibold'>69420 </span>
                    Projects Submitted
                </p>
            </div>
        </footer>
